      ...
      if (resendApiKey) {
        ...
        const confirmationHtml = `
          ...
          <html>
            ...
            <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
              <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
                <h1 style="color: #AB090A; margin-top: 0;">Thank you for contacting us</h1>
                <p style="color: #666; margin-bottom: 0;">Hi ${sanitizedName}, we have received your message and will get back to you soon.</p>
              </div>
              <div style="background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px;">
                <p style="margin: 0 0 15px 0;">Our team typically responds within 1–2 business days. If your matter is urgent, feel free to call us:</p>
                <p style="margin: 0;"><strong>Phone:</strong> <a href="tel:+919220286089" style="color: #AB090A;">+91-9220286089</a> / <a href="tel:+918851753005" style="color: #AB090A;">+91-8851753005</a></p>
                <p style="margin: 10px 0 0 0;"><strong>Email:</strong> <a href="mailto:sahil@rkgproperties.in" style="color: #AB090A;">sahil@rkgproperties.in</a></p>
              </div>
              <div style="margin-top: 20px; padding: 15px; background-color: #f8f9fa; border-radius: 8px; text-align: center; color: #666; font-size: 12px;">
        ...
        const confirmResult = await resend.emails.send({
          from: fromEmail,
          to: sanitizedEmail,
          subject: 'We received your message – RKG Properties and Constructions',
