    ...
    <div className="page-shell">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <nav className="mb-8 text-sm text-[#a3a3a3]">
          <Link href="/" className="golden-text hover:underline">Home</Link>
          <span className="mx-2">/</span>
          <span className="text-[#f5f5f5]">Privacy Policy</span>
        </nav>

        <h1 className="text-3xl md:text-4xl font-bold font-serif-display text-[#f5f5f5] mb-2">
          Privacy Policy
        </h1>
        <p className="text-[#737373] text-sm mb-12">
          Last updated: {new Date().toLocaleDateString('en-IN', { day: 'numeric', month: 'long', year: 'numeric' })}
        </p>

        <div className="card-luxury p-6 md:p-10 space-y-10">
          {/* 1. Introduction */}
          <section>
            <h2 className="text-xl font-bold font-serif-display text-[#f5f5f5] mb-3 flex items-center gap-2">
              <span className="golden-text">1.</span> Introduction
            </h2>
          ...
          <section>
            <h2 className="text-xl font-bold font-serif-display text-[#f5f5f5] mb-3 flex items-center gap-2">
              <span className="golden-text">2.</span> Information We Collect
            </h2>
            <p className="text-[#a3a3a3] leading-relaxed mb-3">
              We may collect the following information:
            </p>
            <ul className="list-disc list-inside text-[#a3a3a3] space-y-2 ml-2">
              <li>Full name</li>
              <li>Phone number</li>
              <li>Email address</li>
          ...
          <section>
            <h2 className="text-xl font-bold font-serif-display text-[#f5f5f5] mb-3 flex items-center gap-2">
              <span className="golden-text">3.</span> How We Use Your Information
            </h2>
            <p className="text-[#a3a3a3] leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold font-serif-display text-[#f5f5f5] mb-3 flex items-center gap-2">
              <span className="golden-text">4.</span> Data Sharing & Disclosure
            </h2>
            <p className="text-[#a3a3a3] leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold font-serif-display text-[#f5f5f5] mb-3 flex items-center gap-2">
              <span className="golden-text">5.</span> Google Ads & Tracking Disclosure
            </h2>
            <p className="text-[#a3a3a3] leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold font-serif-display text-[#f5f5f5] mb-3 flex items-center gap-2">
              <span className="golden-text">6.</span> Cookies Policy
            </h2>
            <p className="text-[#a3a3a3] leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold font-serif-display text-[#f5f5f5] mb-3 flex items-center gap-2">
              <span className="golden-text">7.</span> Data Security
            </h2>
            <p className="text-[#a3a3a3] leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold font-serif-display text-[#f5f5f5] mb-3 flex items-center gap-2">
              <span className="golden-text">8.</span> User Consent
            </h2>
            <p className="text-[#a3a3a3] leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold font-serif-display text-[#f5f5f5] mb-3 flex items-center gap-2">
              <span className="golden-text">9.</span> Contact Information
            </h2>
            <p className="text-[#a3a3a3] leading-relaxed mb-4">
              If you have any questions regarding this Privacy Policy, please contact us:
            </p>
            <div className="section-muted rounded-lg p-4 space-y-2 text-[#a3a3a3] border border-[#2a2a2a]">
              <p><span className="font-semibold text-[#f5f5f5]">Business Name:</span> RKG Properties & Constructions</p>
              <p><span className="font-semibold text-[#f5f5f5]">Phone:</span> <a href="tel:+919220286089" className="golden-text hover:underline">9220286089</a></p>
              <p><span className="font-semibold text-[#f5f5f5]">Email:</span> <a href="mailto:sahil@rkgproperties.in" className="golden-text hover:underline">sahil@rkgproperties.in</a></p>
              <p><span className="font-semibold text-[#f5f5f5]">Website:</span> <a href="https://www.rkgproperties.in" className="golden-text hover:underline">www.rkgproperties.in</a></p>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold font-serif-display text-[#f5f5f5] mb-3 flex items-center gap-2">
              <span className="golden-text">10.</span> Policy Updates
            </h2>
            <p className="text-[#a3a3a3] leading-relaxed">
        ...
        <div className="mt-8 text-center">
          <Link
            href="/"
            className="golden-text font-semibold hover:underline"
          >
            ← Back to Home
          </Link>
        </div>
