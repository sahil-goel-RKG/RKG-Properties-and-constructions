...
export default function ContactPopup() {
  ...
  return (
    ...
    >
      <div className="relative bg-white rounded-lg shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto mx-auto p-4 sm:p-6 md:p-8 animate-in fade-in zoom-in duration-300">
        {/* Close button - invisible but interactable */}
        <button
          onClick={handleClose}
          onMouseDown={(e) => e.stopPropagation()}
          onTouchStart={(e) => e.stopPropagation()}
          className="absolute top-2 left-2 w-11 h-11 sm:w-10 sm:h-10 flex items-center justify-center cursor-pointer z-[10000] opacity-0 touch-manipulation"
